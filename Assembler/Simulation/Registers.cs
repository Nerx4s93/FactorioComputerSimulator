    ...
    private readonly Dictionary<string, byte> _registers = new Dictionary<string, byte>()
        {
            ...
            { "Sba", 0 }, // Старший байт, указывающий на начало стека
            { "Sbb", 0 }, // Младший байт, указывающий на начало стека
            { "Spa", 0 }, // Старший байт, указывающий на вершину стека
            { "Spb", 0 }, // Младший байт, указывающий на вершину стека
            { "Sc", 0 }, // Конфиг стека: 1 бит - направление стека, остальные - размер стека

            { "Cba", 0 }, // Старший байт, указывающий на начало стека вызовов
            { "Cbb", 0 }, // Младший байт, указывающий на начало стека вызовов
            { "Cpa", 0 }, // Старший байт, указывающий на вершину стека вызовов
            { "Cpb", 0 }, // Младший байт, указывающий на вершину стека вызовов
            { "Cc", 0 }, // Конфиг стека: 1 бит - направление стека, остальные - размер стека
