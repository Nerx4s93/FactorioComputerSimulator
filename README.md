...
### Регистры стека
1) Ss1, Ss2 - регистры, указывающие на начало стека
   Ss1 - старший байт.
   Ss2 - младший байт.
2) Sn1, Sn2 - регистры, указывающие на последний элемент в стеке.
   Sn1 - старший байт.
   Sn2 - младший байт.
3) Sc - конфиг стека.
   255 - возрастающий стек.
   0 - убывающий стек.  
...
|-------------|---------------------------|----------------------------------|
| 0           | RAM\[H_K\] <- M           | store                            |
| 1           | RAM\[const_const\] <- M   | store 0b00000000, 0b10000011     |
| 2           | RAM\[H_K\] <- reg         | store B                          |
| 3           | RAM\[const_const\] <- reg | store B,  0b00000000, 0b10000011 |
